...
The reasoning and planning processes can introduce latency, making it less suitable for fast-paced games like _Doom_ or _Super Mario Bros._
...
However, turn-based games like _Pokémon_ are ideal candidates, as they allow the AI enough time to deliberate and make strategic decisions.
