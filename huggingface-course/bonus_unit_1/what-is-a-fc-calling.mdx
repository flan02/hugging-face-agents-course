...
1. _Think_ : What action(s) do I need to take in order to fulfill the objective.
2. _Act_ : Format the action with the correct parameter and stop the generation.
3. _Observe_ : Get back the result from the execution.
